...
/**
 * This is the interface driven "Combinatorpattern", instead of class "CustomerValidatorService"
 */
...
public interface CustomerRegistrationValidator extends Function<Customer, ValidationResult> {
    ...
    static CustomerRegistrationValidator isPhoneNumberValid() {
        return customer -> customer.getPhoneNumber().startsWith("+61") ? ValidationResult.SUCCESS : ValidationResult.PHONE_NUMBER_NOT_VALID;
    }
